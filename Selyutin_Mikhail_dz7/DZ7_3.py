...
class Cell:
    ...
    def __sub__(self, other):
        if self.number >= other.number:
            return Cell(self.number - other.number)
        print(f'Invalid operation: {self.number} less then {other.number}')
    ...
    def make_order(self, number_row):
        strange = ""
        for el in range(self.number // number_row):
            strange = f"{strange}{'*' * number_row}\n"
        if self.number % number_row:
            strange = f"{strange}{'*' * (self.number % number_row)}\n"
        return strange
