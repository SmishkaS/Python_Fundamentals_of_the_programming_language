...
class Coat(Clothing):
    ...
    def __str__(self):
        return '[' + self.name + ' size ' + str(self.v) + ']'
...
class Suit(Clothing):
    ...
    def __str__(self):
        return '[' + self.name + ' size ' + str(self.h) + ']'
...
coat = Coat(52)
print(coat, '; fabrics need:', coat.fabric_consumption)

suit = Suit(48)
print(suit, '; fabrics need:', suit.fabric_consumption)
